...
const Page = () => {
  return (
    <AkpagerLayout footer={2} header={2} bodyClass={"home-two"} onePage>
      ...
      <section
        className="services-two-area pt-120 rpt-100 pb-90 rpb-70 rel z-2"
        id="services"
      >
        <div className="container">
      ...
      <section id="about" className="customer-data-area py-120 rpy-100">
        <div className="container">
      ...
      <section
        id="pricing"
        className="pricing-area pt-80 rpt-60 pb-90 rpb-70 rel z-2"
      >
        <div className="container">
      ...
      <section
        id="testimonials"
        className="testimonials-area pb-120 rpb-100 rel z-1"
      >
        <div
      ...
      {/* Blog Area Start */}
      <section id="blog" className="blog-area-two pt-120 rpt-100">
        <div className="container">
          <div className="row justify-content-center">
